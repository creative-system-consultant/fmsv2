<div>
    <x-container title="Withdraw Share" routeBackBtn="{{route('teller.teller-list')}}" titleBackBtn="teller list" disableBackBtn="true">
                            ...
                            <div class="grid grid-cols-1 sgap-4">
                                ...
                                <x-table.table>
                                    <x-slot name="thead">
                                        ...
                                        <x-table.table-header class="text-left" value="LAST PAYMENT DATE" sort="" />
                ...
                <div class="col-span-12 lg:col-span-12 xxl:col-span-12">
                    <x-card title="Transaction Details" >
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                            ...
                            <x-native-select  label="Recipient Bank" wire:model="">
                                <option value="">Name</option>
                            </x-native-select>
