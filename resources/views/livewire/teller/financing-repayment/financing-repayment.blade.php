<div>
    <x-container title="FINANCING REPAYMENT" routeBackBtn="{{route('teller.teller-list')}}" titleBackBtn="teller list" disableBackBtn="true">
            ...
            <div class="grid grid-cols-12 gap-6 mt-4  p-4 rounded-lg dark:bg-gray-900" x-data="{ tab: 0 }">
                <div class="col-span-12 lg:col-span-4 xxl:col-span-4">
                    <x-card title="Category">
                        ...
                        <x-tab.basic-title name="3" wire:click="selectType('C')">
                            <x-icon name="cash" class="w-6 h-6 mr-2"/>
                            Contribution
                        </x-tab.basic-title>
                    </x-card>
                ...
                <div class="col-span-12 lg:col-span-8 xxl:col-span-8">
                    ...
                    <x-card title="{{$type == 'cheque' ? 'Cheque' : ($type == 'cash' ? 'Cash' : ($type == 'SI' ? 'IBT/SI' : 'Contribution')) }} Details" >
