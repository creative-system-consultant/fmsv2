        ...
        <div class="grid grid-cols-1">
            ...
            <div class="grid grid-cols-12 gap-6 mt-4  p-4 rounded-lg dark:bg-gray-900" x-data="{ tab: 2 }">
                ...
                <div class="col-span-12 lg:col-span-8 xxl:col-span-8">
                    <div x-show="tab == 0">
                        <livewire:teller.miscellaneous-out.category.contribution />
                    </div>

                    <div x-show="tab == 1">
                        <livewire:teller.miscellaneous-out.category.members />
                    </div>

                    <div x-show="tab == 2">
                        <livewire:teller.miscellaneous-out.category.financing />
                    </div>

                    <div x-show="tab == 3">
                        <livewire:teller.miscellaneous-out.category.share />
                    </div>
                </div>
            </div>
        </div>
