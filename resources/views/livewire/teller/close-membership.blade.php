<div>
    <div class="grid grid-cols-1">
        <livewire:general.customer-search searchMbrNo=true searchTotShare=true searchTotContribution=true searchFee=true searchMiscAmt=true searchBalDividen=true searchAdvPayment=true customQuery='closeMembership' />
                    ...
                    <div>
                        ...
                        <x-card title="TRANSACTION DETAILS">
                            <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
                                ...
                                <x-inputs.currency class="!pl-[2.5rem]" label="Amount" prefix="RM" thousands="," decimal="." wire:model="txnAmt" disabled />
