<div>
    <x-container title="Languages Maintenance" routeBackBtn="{{route('setting.setting-list')}}" titleBackBtn="setting list" disableBackBtn="true" >
            ...
            <x-card title="">
                ...
                <x-table.table loading="true" loadingtarget="paginated">
                    <x-slot name="thead">
                        ...
                        <x-table.table-header class="text-left" value="LANGUAGES" sort="" />
                    ...
                    <x-slot name="tbody">
                        ...
                        @foreach ($data as $key => $language)
                            <tr>
                                ...
                                <x-table.table-body colspan="" class="text-xs font-medium text-gray-700 ">
                                    {{ $language->institute_id }}
                                </x-table.table-body>

                                <x-table.table-body colspan="" class="text-xs font-medium text-gray-700 ">
                                    <x-button 
                                        wire:click="openUpdateModal({{ $language->id }})"
                                        xs  
                                        icon="pencil-alt" 
                                        orange 
                                        label="Edit" 
    ...
    <!-- modal -->
        ...
        <div class="grid gap-4 my-2 lg:grid-cols-2">
            <div class="tooltip buttom" title="Institute ID must be numberic and maximum 1 characters">
                <x-input wire:model="institute_id" label="Institude ID" placeholder="" class="uppercase" maxlength="2"/>
            </div>
            <div class="tooltip buttom" title="Language must be alphabetic">
