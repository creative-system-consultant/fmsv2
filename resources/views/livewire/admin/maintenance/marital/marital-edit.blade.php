<div>
    ...
    <x-container title="Marital Edit Information" routeBackBtn="" titleBackBtn="" disableBackBtn="">
        <div class="grid sm:grid-cols-3 gap-6 items-center">
            <x-input wire:model="description" label="Marital Name" placeholder="" />
            ...
            <div class="flex gap-3">
                ...
                <x-button wire:click="update('{{ $RefMarital->id }}')" squared positive label="Update" />
            </div>
        </div>
    </x-container>
</div>
