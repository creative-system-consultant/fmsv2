<div>
    ...
    <x-container title="Marital Information" routeBackBtn="" titleBackBtn="" disableBackBtn="">
        <div>
                ...
                <x-slot name="tbody">
                    @foreach ($RefMarital as $marital)
                        <tr>
                            ...
                            <x-table.table-body colspan="" class="text-xs font-medium text-gray-700 ">
                                {{ $marital->status == 1 ? 'ENABLE' : 'DISABLE' }}
                            </x-table.table-body>

                            <x-table.table-body colspan="" class="text-xs font-medium text-gray-700 ">
                                <a href="{{ route('marital.edit',$marital->id) }}" class="inline-flex items-center px-4 py-2 text-sm font-bold text-white bg-orange-500 rounded hover:bg-orange-400">
                                    Edit
                                </a>
                                <button 
                                wire:click="delete({{ $marital->id }})",
