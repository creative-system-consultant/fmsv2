        ...
        <div class="mt-10">
            <div class="pb-4 mb-4 font-semibold border-b dark:border-gray-600">
                <div class="flex items-center justify-between">
                    <div class="flex flex-col-reverse items-start justify-between space-x-2 lg:flex-row lg:items-center">
                        <div wire:loading wire:target="selectedSystem">
                            <svg class="w-5 h-5 text-primary-600 dark:text-white animate-spin" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
                ...
                <div>
                    @foreach ($modules as $module)
                        <div class="grid grid-cols-12">
                            <div class="flex items-start col-span-12 py-3 border md:col-span-3 bg-gray-50 dark:bg-gray-900 text-primary-600 dark:border-gray-600">
                            ...
                            <div class="col-span-12 border md:col-span-9 dark:border-gray-600">
