<div>
    ...
    <x-container title="States Edit Information" routeBackBtn="" titleBackBtn="" disableBackBtn="">
        ...
        <div>
            ...
            <x-button wire:click="update('{{ $RefState->id }}')" squared positive label="Submit" />
        </div>
    </x-container>
</div>
