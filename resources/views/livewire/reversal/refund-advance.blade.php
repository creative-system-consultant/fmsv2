<div>
    <x-container title="REFUND ADVANCE REVERSAL" routeBackBtn="{{route('reversal.reversal-list')}}" titleBackBtn="reversal list" disableBackBtn="true">
            ...
            <div style="margin-top: 30px;">
                <x-table.table>
                    <x-slot name="thead">
                            ...
                            <x-table.table-header class="text-right" value="Advance Amount" sort=""  />
                            <x-table.table-header class="text-left" value="Remaks" sort=""  />
