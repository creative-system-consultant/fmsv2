<div>
    <div class="grid grid-cols-1 ">
        <x-card title="Early Settlement Reversal">
        ...
        {{-- modal --}}
        <div>
            <x-modal.card title="EARLY SETTLEMENT REVERSAL CONFIRMATION" align="center" fullscreen="true" blur wire:model.defer="reversalModal">
                <div class="mb-4">
