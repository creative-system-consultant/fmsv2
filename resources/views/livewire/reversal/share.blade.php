<div>
    <div class="grid grid-cols-1 ">
                    ...
                    <x-slot name="tbody">
                        @forelse($dataTable as $data)
                            <tr>
                                ...
                                <x-table.table-body colspan="" class="text-xs font-medium text-left text-gray-700">
                                        @if ($data->trx_group == 'SHARES' && $data->ref_id_reversal == NULL)
        ...
        {{-- modal --}}
        <div>
            <x-modal.card title="SHARE REVERSAL CONFIRMATION" align="center" fullscreen="true" blur wire:model.defer="reversalModal">
                <div class="mb-4">
