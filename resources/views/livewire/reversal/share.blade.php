<div>
    <x-container title="SHARE REVERSAL" routeBackBtn="{{route('reversal.reversal-list')}}" titleBackBtn="reversal list" disableBackBtn="true">
            ...
            <div style="margin-top: 30px;">
                <x-table.table>
                    <x-slot name="thead">
                        ...
                        <x-table.table-header class="text-center" value="Doc Number" sort=""  />
