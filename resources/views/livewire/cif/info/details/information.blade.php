    ...
    <div class="mt-6">
        <x-card title="Member's Information" >
            <div class="grid grid-cols-1 gap-2 md:grid-cols-3">
                ...
                <x-input label="Year Tabung Khirat" placeholder="" wire:model="year_tabung_khirat" :disabled=$disabled />

                <x-input label="Tabung Khirat" placeholder="" wire:model="amt_tabung_khirat" :disabled=$disabled />
