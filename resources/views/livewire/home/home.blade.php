                    ...
                    <div class="bg-white/70 backdrop-blur-lg py-8 px-6 md:px-12 2xl:px-24 sm:py-4  shadow-lg rounded-lg  sm:h-72 flex flex-col items-center justify-center border dark:bg-gray-900/50 dark:border-black">
                        <div class="grid grid-cols-1 md:grid-cols-2 items-center justify-center dark:text-white">
                            <div class="space-y-2 flex flex-col order-last sm:order-first">
                                ...
                                <div class="pt-4">
                                    <x-button class="py-2 w-full sm:w-fit" wire:navigate href="{{ route('cif.main') }}" icon="arrow-circle-right" primary label=" Go to Member Info" />
                                </div>
                            </div>
                        ...
                        <div class="bg-white dark:bg-gray-800 dark:border-black py-6 shadow-lg rounded-lg flex flex-col px-4 border mt-6 relative" >
                            <div class="bg-white rounded-lg shadow-sm mb-4 dark:bg-gray-900 flex overflow-x-auto overflow-y-hidden">
