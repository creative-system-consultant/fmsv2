...
use App\Traits\Reversal\ContributionPlaceholder;
...
{
    use Actions, WithPagination, ContributionPlaceholder;
    ...
    public static function formatData($data)
    {
        return [
            ...
            'ACTION' => [
                'value' => ($data->trx_group == 'CONTRIBUTION' && $data->ref_id_reversal == NULL) ? 'reverse("' . $data->id . '")' : 'DONE',
                'align' => 'center'
            ],
        ];
    }
    ...
    public function getData()
    {
        ...
        $rawData = FmsMembershipStatement::select(
            ...
            ->whereIn('REF.TRANSACTION_CODES.trx_group', ['CONTRIBUTION', 'CONTRIBUTION - Balance C/F', 'CONTRIBUTION (REVERSAL)'])
