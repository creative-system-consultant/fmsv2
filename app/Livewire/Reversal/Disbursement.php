...
class Disbursement extends Component
{
    ...
    public static function formatData($data)
    {
        return [
            ...
            'ACTION' => [
                'value' => ($data->trx_group == 'DISB' && $data->ref_id_reversal == NULL) ? 'reverse("'. $data->id .'")' : 'DONE',
                'align' => 'center'
            ],
        ];
    }
    ...
    public function getData()
    {
        ...
        $rawData = FmsAccountStatement::select(
            ...
            DB::raw('transaction_code_id = FMS.uf_get_transaction_code_desc(' . $this->clientId . ', FMS.ACCOUNT_STATEMENTS.transaction_code_id)'),
