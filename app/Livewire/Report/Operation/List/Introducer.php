...
use App\Action\StoredProcedure\SpFmsUpRptListIntroducer;
...
{   
    ...
    {
        return SpFmsUpRptListIntroducer::getRawData([
    ...
    public function generateExcel()
    {
        ...
        if(count($rawData) > 0) {
            ...
            foreach ($rawData as $data) {
                $formattedData[] = SpFmsUpRptListIntroducer::formatDataForExcel($data);
            }
    ...
    {
        $data = SpFmsUpRptListIntroducer::handleForTable($rawData, true);
    ...
    private function handleExcel($rawData)
    {
        ...
        $filename = 'ListOfIntroducer-%s.xlsx';
    ...
    public function render()
    {
        ...
        return view('livewire.report.operation.list.introducer', [
            'result' => $result
