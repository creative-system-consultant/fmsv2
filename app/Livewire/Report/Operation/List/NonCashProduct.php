...
use App\Action\StoredProcedure\SpFmsUpRptListNonCashProduct;
...
class NonCashProduct extends Component
{   
    ...
    {
        return SpFmsUpRptListNonCashProduct::getRawData([
    ...
    public function generateExcel()
    {
        ...
        if(count($rawData) > 0) {
            ...
            foreach ($rawData as $data) {
                $formattedData[] = SpFmsUpRptListNonCashProduct::formatDataForExcel($data);
            }
    ...
    {
        $data = SpFmsUpRptListNonCashProduct::handleForTable($rawData, true);
    ...
    private function handleExcel($rawData)
    {
        ...
        $filename = 'ListOfNonCashProduct-%s.xlsx';
    ...
    public function render()
    {
        ...
        return view('livewire.report.operation.list.non-cash-product', [
            'result' => $result
