...
use App\Action\StoredProcedure\SpFmsUpRptBskeGoldbarTrx;
...
class BskeGoldbarTrx extends Component
{   
    ...
    {
        return SpFmsUpRptBskeGoldbarTrx::getRawData([
    ...
    public function generateExcel()
    {
        ...
        if(count($rawData) > 0) {
            ...
            foreach ($rawData as $data) {
                $formattedData[] = SpFmsUpRptBskeGoldbarTrx::formatDataForExcel($data);
            }
    ...
    {
        $data = SpFmsUpRptBskeGoldbarTrx::handleForTable($rawData, true);
    ...
    private function handleExcel($rawData)
    {
        ...
        $filename = 'ListOfBskeGoldbarTrx-%s.xlsx';
    ...
    public function render()
    {
        ...
        return view('livewire.report.operation.list.bske-goldbar-trx', [
            'result' => $result
