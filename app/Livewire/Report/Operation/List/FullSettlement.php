...
use App\Action\StoredProcedure\SpFmsUpRptFullSettlementList;
...
class FullSettlement extends Component
{   
    ...
    {
        return SpFmsUpRptFullSettlementList::getRawData([
    ...
    public function generateExcel()
    {
        ...
        if(count($rawData) > 0) {
            ...
            foreach ($rawData as $data) {
                $formattedData[] = SpFmsUpRptFullSettlementList::formatDataForExcel($data);
            }
    ...
    {
        $data = SpFmsUpRptFullSettlementList::handleForTable($rawData, true);
    ...
    private function handleExcel($rawData)
    {
        ...
        $filename = 'ListOfFullSettlement-%s.xlsx';
    ...
    public function render()
    {
        ...
        return view('livewire.report.operation.list.full-settlement', [
            'result' => $result
