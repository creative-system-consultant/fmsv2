...
use App\Action\StoredProcedure\SpFmsUpRptDeductionList;
...
class Deduction extends Component
{
    ...
    {
        return SpFmsUpRptDeductionList::getRawData([
    ...
    public function generateExcel()
    {
        ...
        if(count($rawData) > 0) {
            ...
            foreach ($rawData as $data) {
                $formattedData[] = SpFmsUpRptDeductionList::formatDataForExcel($data);
            }
    ...
    {
        $data = SpFmsUpRptDeductionList::handleForTable($rawData, true);
    ...
    private function handleExcel($rawData)
    {
        ...
        $filename = 'ListOfDeduction-%s.xlsx';
    ...
    public function render()
    {
        ...
        return view('livewire.report.operation.list.deduction', [
            'result' => $result
