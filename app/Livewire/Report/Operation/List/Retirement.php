...
use App\Action\StoredProcedure\SpFmsUpRptRetirementList;
...
{   
    ...
    {
        return SpFmsUpRptRetirementList::getRawData([
    ...
    public function generateExcel()
    {
        ...
        if(count($rawData) > 0) {
            ...
            foreach ($rawData as $data) {
                $formattedData[] = SpFmsUpRptRetirementList::formatDataForExcel($data);
            }
    ...
    {
        $data = SpFmsUpRptRetirementList::handleForTable($rawData, true);
    ...
    private function handleExcel($rawData)
    {
        ...
        $filename = 'ListOfRetirement-%s.xlsx';
    ...
    public function render()
    {
        ...
        return view('livewire.report.operation.list.retirement', [
            'result' => $result
