...
class Payment extends Component
{
    ...
    {
        return SpFmsContributionPayment::getRawData([
    ...
    public function generateExcel()
    {
        ...
        if (count($rawData) > 0) {
            ...
            foreach ($rawData as $data) {
                $formattedData[] = SpFmsContributionPayment::formatDataForExcel($data);
            }
    ...
    {
        $data = SpFmsContributionPayment::handleForTable($rawData, true);
    ...
    public function render()
    {
        ...
        return view('livewire.report.operation.contribution.payment', [
            'result' => $result
