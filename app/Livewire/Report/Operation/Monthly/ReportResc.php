...
use App\Action\StoredProcedure\SpUpRptMonthArrearsReportResche;
...
class ReportResc extends Component
{
    ...
    {
        return SpUpRptMonthArrearsReportResche::getRawData([
    ...
    public function generateExcel()
    {
        ...
        if (count($rawData) > 0) {
            ...
            foreach ($rawData as $data) {
                $formattedData[] = SpUpRptMonthArrearsReportResche::formatDataForExcel($data);
            }
    ...
    {
        $data = SpUpRptMonthArrearsReportResche::handleForTable($rawData, true);
    ...
    private function handleExcel($rawData)
    {
        ...
        $filename = 'ReportRescheduleMonthly-%s.xlsx';
    ...
    public function render()
    {
        ...
        return view('livewire.report.operation.monthly.report-resc', [
            'result' => $result
