...
use App\Action\StoredProcedure\SpFmsUpRptMthListShareDetail;
...
class ListShareDetail extends Component
{
    ...
    {
        return SpFmsUpRptMthListShareDetail::getRawData([
    ...
    public function generateExcel()
    {
        ...
        if (count($rawData) > 0) {
            ...
            foreach ($rawData as $data) {
                $formattedData[] = SpFmsUpRptMthListShareDetail::formatDataForExcel($data);
            }
    ...
    {
        $data = SpFmsUpRptMthListShareDetail::handleForTable($rawData, true);
    ...
    private function handleExcel($rawData)
    {
        ...
        $filename = 'Monthly_ListShareDetail-%s.xlsx';
    ...
    public function render()
    {
        ...
        return view('livewire.report.operation.monthly.list-share-detail', [
            'result' => $result
