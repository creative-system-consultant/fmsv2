...
use App\Action\StoredProcedure\SpFmsUpRptMthShareSummaryYearly;
...
class ShareSummaryYearly extends Component
{
    ...
    {
        return SpFmsUpRptMthShareSummaryYearly::getRawData([
    ...
    public function generateExcel()
    {
        ...
        if (count($rawData) > 0) {
            ...
            foreach ($rawData as $data) {
                $formattedData[] = SpFmsUpRptMthShareSummaryYearly::formatDataForExcel($data);
            }
    ...
    {
        $data = SpFmsUpRptMthShareSummaryYearly::handleForTable($rawData, true);
    ...
    private function handleExcel($rawData)
    {
        ...
        $filename = 'Monthly_Share_Summary_Yearly-%s.xlsx';
    ...
    public function render()
    {
        ...
        return view('livewire.report.operation.monthly.share-summary-yearly', [
            'result' => $result
