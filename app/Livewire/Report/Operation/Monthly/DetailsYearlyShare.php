...
use App\Action\StoredProcedure\SpFmsUpRptMthDetailsYearlyShare;
...
class DetailsYearlyShare extends Component
{
    ...
    {
        return SpFmsUpRptMthDetailsYearlyShare::getRawData([
    ...
    public function generateExcel()
    {
        ...
        if (count($rawData) > 0) {
            ...
            foreach ($rawData as $data) {
                $formattedData[] = SpFmsUpRptMthDetailsYearlyShare::formatDataForExcel($data);
            }
    ...
    {
        $data = SpFmsUpRptMthDetailsYearlyShare::handleForTable($rawData, true);
    ...
    private function handleExcel($rawData)
    {
        ...
        $filename = 'Monthly_Detaills_Yearly_Share-%s.xlsx';
    ...
    public function render()
    {
        ...
        return view('livewire.report.operation.monthly.details-yearly-share', [
            'result' => $result
