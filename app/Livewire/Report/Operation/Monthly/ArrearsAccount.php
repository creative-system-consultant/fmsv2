...
use App\Action\StoredProcedure\SpFmsUpRptMthArrearsAccount;
...
class ArrearsAccount extends Component
{
    ...
    {
        return SpFmsUpRptMthArrearsAccount::getRawData([
    ...
    public function generateExcel()
    {
        ...
        if (count($rawData) > 0) {
            ...
            foreach ($rawData as $data) {
                $formattedData[] = SpFmsUpRptMthArrearsAccount::formatDataForExcel($data);
            }
    ...
    {
        $data = SpFmsUpRptMthArrearsAccount::handleForTable($rawData, true);
    ...
    private function handleExcel($rawData)
    {
        ...
        $filename = 'MonthlyArrearsAccount-%s.xlsx';
    ...
    public function render()
    {
        ...
        return view('livewire.report.operation.monthly.arrears-account',[
            'result' => $result
