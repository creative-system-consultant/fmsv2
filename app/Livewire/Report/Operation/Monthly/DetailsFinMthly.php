...
use App\Action\StoredProcedure\SpUpRptDetailsFinancingMonthly;
...
class DetailsFinMthly extends Component
{
    ...
    {
        return SpUpRptDetailsFinancingMonthly::getRawData([
    ...
    public function generateExcel()
    {
        ...
        if (count($rawData) > 0) {
            ...
            foreach ($rawData as $data) {
                $formattedData[] = SpUpRptDetailsFinancingMonthly::formatDataForExcel($data);
            }
    ...
    {
        $data = SpUpRptDetailsFinancingMonthly::handleForTable($rawData, true);
    ...
    public function render()
    {
        ...
        return view('livewire.report.operation.monthly.details-fin-mthly', [
            'result' => $result
