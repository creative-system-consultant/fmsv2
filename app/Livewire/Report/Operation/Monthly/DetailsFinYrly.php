...
use App\Action\StoredProcedure\SpUpRptDetailsFinancingYearly;
...
class DetailsFinYrly extends Component
{
    ...
    {
        return SpUpRptDetailsFinancingYearly::getRawData([
    ...
    public function generateExcel()
    {
        ...
        if (count($rawData) > 0) {
            ...
            foreach ($rawData as $data) {
                $formattedData[] = SpUpRptDetailsFinancingYearly::formatDataForExcel($data);
            }
    ...
    {
        $data = SpUpRptDetailsFinancingYearly::handleForTable($rawData, true);
    ...
    public function render()
    {
        ...
        return view('livewire.report.operation.monthly.details-fin-yrly', [
            'result' => $result
