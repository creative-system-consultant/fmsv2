...
use App\Action\StoredProcedure\SpUpRptMthNpfAcc;
...
class MthlyNpfAcc extends Component
{
    ...
    {
        return SpUpRptMthNpfAcc::getRawData([
    ...
    public function generateExcel()
    {
        ...
        if (count($rawData) > 0) {
            ...
            foreach ($rawData as $data) {
                $formattedData[] = SpUpRptMthNpfAcc::formatDataForExcel($data);
            }
    ...
    {
        $data = SpUpRptMthNpfAcc::handleForTable($rawData, true);
    ...
    private function handleExcel($rawData)
    {
        ...
        $filename = 'MonthlyNpfAccount-%s.xlsx';
    ...
    public function render()
    {
        ...
        return view('livewire.report.operation.monthly.mthlynpfacc', [
            'result' => $result
