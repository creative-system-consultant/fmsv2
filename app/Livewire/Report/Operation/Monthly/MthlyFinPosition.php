...
use App\Action\StoredProcedure\SpUpRptMthFinancingPosition;
...
class MthlyFinPosition extends Component
{
    ...
    {
        return SpUpRptMthFinancingPosition::getRawData([
    ...
    public function generateExcel()
    {
        ...
        if (count($rawData) > 0) {
            ...
            foreach ($rawData as $data) {
                $formattedData[] = SpUpRptMthFinancingPosition::formatDataForExcel($data);
            }
    ...
    {
        $data = SpUpRptMthFinancingPosition::handleForTable($rawData, true);
    ...
    private function handleExcel($rawData)
    {
        ...
        $filename = 'MonthlyFinancingPosition-%s.xlsx';
    ...
    public function render()
    {
        ...
        return view('livewire.report.operation.monthly.mthly-fin-position', [
            'result' => $result
