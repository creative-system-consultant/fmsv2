...
class Contribution extends Component
{
    ...
    public $totalContribution, $lastPaymentAmt, $monthlyContribution, $lastWithdrawAmt, $lastWithdrawDate, $numWithdraw, $totalWithdraw;
    ...
    public function render()
    {
        ...
        $contributions = DB::table('FMS.MEMBERSHIP_STATEMENTS')
            ->select(
            ...
            ->where('FMS.MEMBERSHIP_STATEMENTS', $this->clientID)
