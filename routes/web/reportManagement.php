...
use App\Livewire\Report\Management\MonthlyNpf\MonthlyNpfSummary;
...
Route::get('monthly-npf/monthly-npf-summary', MonthlyNpfSummary::class)->name('monthly-npf.monthly-npf-summary');
