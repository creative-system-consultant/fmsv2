...
use App\Livewire\Admin\Maintenance\ConceptCode;
use App\Livewire\Admin\Maintenance\CustType;
use App\Livewire\Admin\Maintenance\Department;
...
Route::get('cust-type', CustType::class)->name('cust-type');
Route::get('occupation', Occupation::class)->name('occupation');
Route::get('concept-code', ConceptCode::class)->name('concept-code');
Route::get('occupation', Occupation::class)->name('occupation');
